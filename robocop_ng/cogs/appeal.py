...
class Appeal(Cog):
    ...
    async def on_message(self, message):
        ...
        if message.channel.id == 402019542345449472 and message.author.id == 402016472878284801:
