...
class mdthread(Cog):
    ...
    async def mdping(self, ctx: Context, *, content: str):
        ...
        reaction = [element for element in reaction_message.reactions if element.emoji.id == 906980837092909136][0]
        ...
        await ctx.reply(
            ...
            view = ConfirmationButtonView(
                ...
                yes_action = lambda: self.send_message(ctx, f"{' '.join(mentions)} {content}"),
